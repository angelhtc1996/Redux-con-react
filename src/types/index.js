...
export const OBTENER_IMAGEN_EDITAR = 'OBTENER_IMAGEN_EDITAR';
export const OBTENER_IMAGEN_EXITO = 'OBTENER_IMAGEN_EXITO';
export const OBTENER_IMAGEN_ERROR = 'OBTENER_IMAGEN_ERROR';
